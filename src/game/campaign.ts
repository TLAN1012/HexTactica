...
export const MISSIONS: MissionDef[] = [
  {
    ...
    briefing: "血狼劫掠團燒了河谷的哨站。帶上你的第一批兵,把殘餘的劫掠者趕出去 — 這是你成為戰團指揮官的第一戰。",
    mapSeed: 101, mapWidth: 11, mapHeight: 8,
    enemies: [
      { typeId: "infantry", level: 1 },
      { typeId: "infantry", level: 1 },
    ],
    reward: 180,
  },
  {
    ...
    briefing: "劫掠者盯上了磨坊的存糧,這次還帶了弓手。記住:近戰會挨反擊,先用自己的遠程削弱他們。",
    mapSeed: 202, mapWidth: 12, mapHeight: 8,
    enemies: [
      { typeId: "infantry", level: 1 },
      { typeId: "infantry", level: 1 },
      { typeId: "archer", level: 1 },
    ],
    reward: 220,
  },
  {
    id: "m03", index: 3, title: "淺灘伏擊",
    briefing: "斥候回報敵人的騎兵在淺灘附近遊蕩。長槍兵能先制反擊並克制騎兵 — 讓馬撞上槍陣。",
    mapSeed: 303, mapWidth: 12, mapHeight: 9,
    enemies: [
      { typeId: "light-cavalry", level: 1 },
      { typeId: "infantry", level: 1 },
      { typeId: "infantry", level: 2 },
    ],
    reward: 260,
  },
  {
  ...
  },
  {
    ...
    briefing: "護送商隊穿越林道時撞上劫掠團主力的前鋒。森林能提供 25% 減傷 — 誰先佔住樹林,誰就佔便宜。",
    mapSeed: 505, mapWidth: 13, mapHeight: 9,
    enemies: [
      { typeId: "infantry", level: 2 },
      { typeId: "infantry", level: 2 },
      { typeId: "velite", level: 2 },
      { typeId: "light-cavalry", level: 2 },
    ],
    reward: 380,
  },
  {
    id: "m06", index: 6, title: "斷橋防線",
    briefing: "劫掠團要渡河突襲糧倉,渡口只有一兩處。用地形卡住渡口,讓他們一隊一隊排隊送死。",
    mapSeed: 616, mapWidth: 14, mapHeight: 9,
    enemies: [
      { typeId: "spearman", level: 2 },
      { typeId: "infantry", level: 2 },
      { typeId: "archer", level: 2 },
      { typeId: "archer", level: 2 },
      { typeId: "velite", level: 1 },
    ],
    reward: 450,
  },
  {
    id: "m07", index: 7, title: "鐵蹄突襲",
    briefing: "敵人湊出了一支騎兵矛頭,打算一波沖垮我們。槍陣立正面、弓手置後排,反衝鋒的時機由你決定。",
    mapSeed: 707, mapWidth: 14, mapHeight: 10,
    enemies: [
      { typeId: "heavy-cavalry", level: 1 },
      { typeId: "light-cavalry", level: 2 },
      { typeId: "light-cavalry", level: 2 },
      { typeId: "infantry", level: 2 },
      { typeId: "spearman", level: 2 },
  ...
  },
  {
    ...
    briefing: "血狼僱來了南方的長弓傭兵,射程覆蓋半個戰場。躲在丘陵後推進,騎兵必須在兩回合內摸到他們。",
    mapSeed: 808, mapWidth: 15, mapHeight: 10,
    enemies: [
      { typeId: "longbow", level: 2 },
      { typeId: "longbow", level: 2 },
      { typeId: "spearman", level: 2 },
      { typeId: "spearman", level: 2 },
  ...
  {
    id: "m09", index: 9, title: "血狼大營",
    briefing: "直搗劫掠團大營。敵人傾巢而出,步、弓、騎俱全 — 這是總攻前最後的硬仗,別留手。",
    mapSeed: 909, mapWidth: 15, mapHeight: 10,
    enemies: [
      { typeId: "infantry", level: 3 },
      { typeId: "spearman", level: 3 },
      { typeId: "archer", level: 3 },
      { typeId: "longbow", level: 2 },
      { typeId: "light-cavalry", level: 3 },
      { typeId: "heavy-cavalry", level: 2 },
    ],
    reward: 900,
  },
  {
    id: "m10", index: 10, title: "血狼酋首",
    briefing: "酋首親率鐵甲親衛隊出戰。他的重騎兵衝鋒能踏平一切 — 但你已經知道怎麼對付騎兵了,對吧?終結這場戰爭。",
    mapSeed: 1010, mapWidth: 16, mapHeight: 10,
    enemies: [
      { typeId: "heavy-cavalry", level: 3 },
      { typeId: "heavy-cavalry", level: 3 },
      { typeId: "spearman", level: 3 },
